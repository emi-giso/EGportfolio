  ...
  return (
    <section id="contact" className="py-32 md:py-40 section-padding bg-card/50">
      <div className="max-w-4xl mx-auto text-center">
        <ScrollReveal>
          <p className="text-coral font-body text-sm uppercase tracking-[0.2em] mb-4">{t.contact.label[lang]}</p>
        </ScrollReveal>
        ...
        <ScrollReveal delay={0.1}>
          <h2 className="font-display text-4xl sm:text-5xl md:text-6xl font-bold leading-tight mb-6">
            ...
            <br />
            <span className="text-gradient">{t.contact.heading2[lang]}</span>
          </h2>
        </ScrollReveal>
      ...
      <div className="max-w-6xl mx-auto mt-24 pt-8 border-t border-border">
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="font-display text-sm text-muted-foreground">© 2026 Emilia Giso</p>
