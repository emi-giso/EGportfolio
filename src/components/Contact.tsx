      ...
      <div className="max-w-4xl mx-auto text-center relative z-10">
        <ScrollReveal>
          <div className="inline-flex items-center gap-3 mb-20 md:mb-24 pointer-events-none bg-secondary/30 px-5 py-2.5 rounded-full border border-border/30 backdrop-blur-sm">
            <span className="w-2.5 h-2.5 rounded-full bg-coral animate-pulse shadow-[0_0_10px_rgba(255,107,107,0.5)]" />
            <span className="text-coral font-body text-xs md:text-sm uppercase tracking-[0.2em] font-bold">
        ...
        <ScrollReveal delay={0.1}>
          <h2 className="font-display text-5xl sm:text-6xl md:text-8xl font-black leading-tight mb-24 md:mb-32 text-coral">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6 mt-8">
            {contactLinks.map((link) => (
              <a
                ...
                className="group flex flex-1 sm:flex-none items-center justify-center gap-4 bg-card/60 border border-border/80 rounded-2xl px-6 py-4 hover:bg-secondary hover:border-coral/50 transition-all duration-300 active:scale-[0.98] w-full sm:w-auto shadow-sm backdrop-blur-md"
              >
                <div className="bg-secondary/80 p-3 rounded-full group-hover:bg-coral group-hover:text-white transition-all text-muted-foreground shadow-inner">
                  <link.icon className="w-5 h-5" />
                </div>
                <span className="text-foreground text-base md:text-lg font-bold tracking-wide group-hover:text-coral transition-colors">
                  {link.label}
                </span>
              </a>
            ))}
